...
namespace ClientWpfApp.ModelServiceReference {
    ...
    public interface IModelService {
        ...
        System.Collections.ObjectModel.ObservableCollection<SharedModel.Model.RTU.RTU> GetStaticData();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IModelService/GetStaticData", ReplyAction="http://tempuri.org/IModelService/GetStaticDataResponse")]
        System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<SharedModel.Model.RTU.RTU>> GetStaticDataAsync();
        ...
        System.Collections.ObjectModel.ObservableCollection<SharedModel.Model.Signals.DiscreteSignal> GetDiscreteSignalsForRtu(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IModelService/GetDiscreteSignalsForRtu", ReplyAction="http://tempuri.org/IModelService/GetDiscreteSignalsForRtuResponse")]
        System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<SharedModel.Model.Signals.DiscreteSignal>> GetDiscreteSignalsForRtuAsync(int id);
        ...
        System.Collections.ObjectModel.ObservableCollection<SharedModel.Model.Signals.AnalogSignal> GetAnalogSignalsForRtu(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IModelService/GetAnalogSignalsForRtu", ReplyAction="http://tempuri.org/IModelService/GetAnalogSignalsForRtuResponse")]
        System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<SharedModel.Model.Signals.AnalogSignal>> GetAnalogSignalsForRtuAsync(int id);
    }
    ...
    public partial class ModelServiceClient : System.ServiceModel.ClientBase<ClientWpfApp.ModelServiceReference.IModelService>, ClientWpfApp.ModelServiceReference.IModelService {
        ...
        public System.Collections.ObjectModel.ObservableCollection<SharedModel.Model.RTU.RTU> GetStaticData() {
            return base.Channel.GetStaticData();
        }
        
        public System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<SharedModel.Model.RTU.RTU>> GetStaticDataAsync() {
        ...
        public System.Collections.ObjectModel.ObservableCollection<SharedModel.Model.Signals.DiscreteSignal> GetDiscreteSignalsForRtu(int id) {
            return base.Channel.GetDiscreteSignalsForRtu(id);
        }
        
        public System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<SharedModel.Model.Signals.DiscreteSignal>> GetDiscreteSignalsForRtuAsync(int id) {
            return base.Channel.GetDiscreteSignalsForRtuAsync(id);
        }
        
        public System.Collections.ObjectModel.ObservableCollection<SharedModel.Model.Signals.AnalogSignal> GetAnalogSignalsForRtu(int id) {
            return base.Channel.GetAnalogSignalsForRtu(id);
        }
        
        public System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<SharedModel.Model.Signals.AnalogSignal>> GetAnalogSignalsForRtuAsync(int id) {
