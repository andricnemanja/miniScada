...
namespace ModelWcfServiceLibrary.Repository
{
	...
	{
		private readonly IListSerializer<AnalogSignalMapping> serializer;
		...
		public AnalogSignalMappingRepository(IListSerializer<AnalogSignalMapping> serializer)
		{
			this.serializer = serializer;
			AnalogSignalMappingList = new List<AnalogSignalMapping>();
		}
		...
		/// </summary>
		public List<AnalogSignalMapping> AnalogSignalMappingList { get; private set; }
		...
		public AnalogSignalMapping GetByID(int id)
		{
