...
namespace ModbusServiceHost
{
	...
	public sealed class Bootstrapper
	{
		...
		public static ContainerBuilder RegisterContainerBuilder()
		{
			...
			builder.RegisterType<ModbusServiceLibrary.DynamicCacheServiceReference.DynamicCacheManagerServiceClient>().As<ModbusServiceLibrary.DynamicCacheServiceReference.IDynamicCacheManagerService>();
			return builder;
		}
	}
}
